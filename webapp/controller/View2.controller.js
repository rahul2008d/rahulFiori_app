        ...
        onF4Help: function(oEvent){
            ...
            if(!that.cityFragment){
                Fragment.load({
                    ...
                    // View controller doesn't grant access to the fragment automatically, 
                    // hence we need to add the Fragment as a depeedent
                    that.getView().addDependent(that.cityFragment);
                    // Now Bind the data to the popup fragment
